Public Interface ISupplierService
    ...
    Function AddSupplier(ByVal Supplier As Supplier) As OperationResult
    ...
    ''' <exception cref="ArgumentNullException">Ném ra nếu tham số Supplier là Nothing</exception>
    Function UpdateSupplier(ByVal Supplier As Supplier) As OperationResult
    ...
    Function DeleteSupplier(ByVal id As Integer) As Boolean
End Interface